...
class Fidlists(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "Fidlists" # TODO make this more human readable by adding spaces
...
class FidlistsWidget(ScriptedLoadableModuleWidget):
...
class FidlistsLogic(ScriptedLoadableModuleLogic):
  ...
  def run(self, inputVolume, outputVolume, imageThreshold, enableScreenshots=0):
    ...
    if enableScreenshots:
      self.takeScreenshot('FidlistsTest-Start','MyScreenshot',-1)
...
class FidlistsTest(ScriptedLoadableModuleTest):
  """
  ...
  def test_Fidlists1(self):
    ...
    alphaFids.GetDisplayNode().SetSelectedColor(1,0,1) #
